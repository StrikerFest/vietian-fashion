...
// --- NEW: Import useAuth and useRouter ---
...
export default function Navbar() {
    ...
    const handleLogout = async () => {
        ...
        // After sign out, the AuthContext will update
    ...
    return (
        <nav className="bg-gray-800 text-white p-4 sticky top-0 z-50">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                {/* --- MODIFIED: Right-side icons (Cart + Auth) --- */}
                <div className="flex items-center space-x-4">
                    ...
                    {session ? (
                        ...
                        <Link href="/login" className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-3 rounded-md text-sm">
                            Login
                        </Link>
                    )}
                </div>
