...
export default function LowStockAlert({ items }) {
    return (
        <div className="bg-gray-800 p-6 rounded-lg shadow-md h-full border-l-4 border-red-500">
            <h3 className="text-lg font-semibold text-white mb-4">⚠️ Low Stock Alerts</h3>
            <div className="space-y-3">
                ...
                {items.length === 0 && <p className="text-green-400 text-sm">All inventory levels are healthy!</p>}
            </div>
        </div>
    );
}